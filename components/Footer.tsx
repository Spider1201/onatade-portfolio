  ...
  return (
    <footer className="border-t border-white/10 px-6 py-8 sm:px-10 lg:px-16">
      <div className="mx-auto flex w-full max-w-6xl flex-col items-center justify-between gap-5 sm:flex-row">
        <p className="font-mono text-xs text-[#52647c] dark:text-[#91a0b4]">© 2026 Onatade Abdulmajeed</p>
        <div className="flex items-center gap-4" aria-label="Social links">
          {socialLinks.map(({ label, href, icon: Icon }) => (
            <a
              ...
              aria-label={label}
              className="text-[#52647c] dark:text-[#91a0b4] transition hover:scale-110 hover:text-[#f4b860]"
            >
